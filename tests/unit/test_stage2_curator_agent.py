...
from novel_agent.domain.changes import ChapterChangeDraft
...
def harness(draft: ChapterChangeDraft) -> tuple[CuratorReplayAgent, FakeModelEndpoint]:
    ...
    return CuratorReplayAgent(ModelCurator(gateway), runner), endpoint
